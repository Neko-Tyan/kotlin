...
public class BuiltInsSerializer {
    ...
    /*package*/ static final String DEST_DIR = "compiler/frontend/builtins";
    ...
    /*package*/ static void serializeToDir(final File destDir, @Nullable final PrintStream out) throws IOException {
