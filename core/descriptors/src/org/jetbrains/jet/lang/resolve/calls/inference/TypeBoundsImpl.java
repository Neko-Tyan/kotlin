...
public class TypeBoundsImpl implements TypeBounds {
    ...
    public static class Bound {
        ...
        private Bound(@NotNull JetType type, @NotNull BoundKind kind, @NotNull ConstraintPosition position) {
            this.type = type;
            this.kind = kind;
            this.position = position;
        }

        public static Bound create(@NotNull JetType type, @NotNull BoundKind kind, @NotNull ConstraintPosition position) {
            return new Bound(type, kind, position);
        }
    }
    ...
    public void addBound(@NotNull BoundKind kind, @NotNull JetType type, @NotNull ConstraintPosition position) {
        resultValues = null;
        bounds.add(Bound.create(type, kind, position));
    }
