...
public class ConstraintSystemImpl implements ConstraintSystem {
    ...
    public ConstraintSystem copy() {
        return replaceTypeVariables(Functions.<TypeParameterDescriptor>identity(),
            ...
            @Override
            public TypeBoundsImpl apply(TypeBoundsImpl typeBounds) { return typeBounds.copy(); }
        },
    ...
    public ConstraintSystem filterConstraints(@NotNull final Condition<ConstraintPosition> condition) {
        return replaceTypeVariables(Functions.<TypeParameterDescriptor>identity(),
                                    new Function<TypeBoundsImpl, TypeBoundsImpl>() {
            @Override
            public TypeBoundsImpl apply(TypeBoundsImpl typeBounds) { return typeBounds.filter(condition); }
        },
                                    condition);
    }
