...
public class TypeConstraintsImpl implements TypeConstraints {
    ...
    public static class Constraint {
        ...
        private Constraint(@NotNull JetType type, @NotNull BoundKind boundKind, @NotNull ConstraintPosition constraintPosition) {
            this.type = type;
            this.boundKind = boundKind;
            this.constraintPosition = constraintPosition;
        }

        public static Constraint create(@NotNull JetType type, @NotNull BoundKind boundKind, @NotNull ConstraintPosition constraintPosition) {
            return new Constraint(type, boundKind, constraintPosition);
        }
    }
    ...
    public void addConstraint(@NotNull BoundKind boundKind, @NotNull JetType type, @NotNull ConstraintPosition constraintPosition) {
        resultValues = null;
        constraints.add(Constraint.create(type, boundKind, constraintPosition));
    }
