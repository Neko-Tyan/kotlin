...
import static org.jetbrains.jet.lang.resolve.CallableMemberDescriptorUtils.getOverriddenDeclarationDescriptors;
...
public class JetLineMarkerProvider implements LineMarkerProvider {
    ...
    public LineMarkerInfo getLineMarkerInfo(@NotNull PsiElement element) {
        ...
        Set<? extends CallableMemberDescriptor> overriddenMembers = getOverriddenDeclarationDescriptors(
    ...
    private static void iconNavigatorHandler(MouseEvent event, PsiElement elt) {
        ...
        Set<CallableMemberDescriptor> overriddenMembers = getOverriddenDeclarationDescriptors((CallableMemberDescriptor) descriptor);
        if (overriddenMembers.size() == 0) {
            return;
        }
